                        ...
                        <ul class="nav navbar-nav navbar-right" id="user-control-list" component="header/usercontrol" style="margin-top: 12px;">
                            ...
                            <li>
                                ...
                                <li class="dropdown" style="margin-left: 10px;cursor: pointer;">
                                    <p style="margin-top: 15px;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="10" data-close-others="false"><span class=nav-text style="color: #9d9d9d;"><b>Hi</b> <span style="color: #9d9d9d;"><b>{user.username}{user.isConsumer}</b></span></span> <b class="caret"></b>
                                    </p>
